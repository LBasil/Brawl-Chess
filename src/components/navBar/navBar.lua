...
local buttons = {
    ...
    {name = "Collection", icon = "assets/images/icons/collection_icon.png"},
    {name = "Combat", icon = "assets/images/icons/combat_icon.png"},
    {name = "Social", icon = "assets/images/icons/social_icon.png"},
    {name = "Leaderboard", icon = "assets/images/icons/leaderboard_icon.png"}
}
